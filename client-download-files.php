...
<body>
    ...
    <div class="download-container">
        ...
        <div class="detail-section">
            ...
            <a href="client-project-progress.php?id=<?php echo $deal_id; ?>" class="btn btn-outline">
                <i class="fas fa-chart-line"></i> View Progress
            </a>
            <a href="deal-page-simple.php?id=<?php echo $deal_id; ?>" class="btn btn-primary">
                <i class="fas fa-comments"></i> View Deal Page
            </a>
        </div>
    </div>
